...
const Main = () => {
    ...
    const handleStop = () => {
        setInput("");
        // You might want to add additional logic here to actually stop the response generation
        // This would depend on how your Context handles the API calls
    };
                ...
                <div className="main-bottom">
                    <div className="search-box">
                        ...
                        <div className="icon-container">
                            {!loading && <button><img src={assets.gallery_icon} alt=""/></button>}
                            {!loading && <button><img src={assets.mic_icon} alt=""/></button>}
                            {loading ? (
                                <button onClick={handleStop}><img src={assets.stop_icon} alt="Stop"/></button>
                            ) : (
